...
namespace InstallerLib
{
    ...
    public class ResourceUpdate
    {
        ...
        private static extern bool UpdateResource(
            ...
            IntPtr lpType, // resource type (l'API è molto strana perchè puo prendere ho una stringa o un intero, vedi MAKEINTRESOURCE)
            IntPtr lpName, // resource name
        ...
        public static void UpdateResourceWithFile(string p_BinFileName, IntPtr p_ResourceName, IntPtr p_ResourceType, UInt16 p_ResourceLanguage, string p_UpdateSource)
        {
            byte[] l_bmpBuffer;
            using (System.IO.FileStream l_ImageStream = new System.IO.FileStream(p_UpdateSource, System.IO.FileMode.Open, System.IO.FileAccess.Read))
            {
        ...
        public static void UpdateResource(string p_BinFileName, IntPtr p_ResourceName, IntPtr p_ResourceType, byte[] p_Buffer, UInt16 p_ResourceLanguage)
        {
