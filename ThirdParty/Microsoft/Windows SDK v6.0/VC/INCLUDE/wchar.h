...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(wchar_t *, __RETURN_POLICY_DST, _CRTIMP, _wcslwr_l, _wcslwr_s_l, __inout_ecount(_Size) wchar_t, __inout_z wchar_t, _String, __in_opt _locale_t, _Locale)
...
#ifdef __cplusplus
extern "C++" {
inline wchar_t * __CRTDECL wmemchr(__in_ecount(_N) wchar_t *_S, __in wchar_t _C, __in size_t _N)
