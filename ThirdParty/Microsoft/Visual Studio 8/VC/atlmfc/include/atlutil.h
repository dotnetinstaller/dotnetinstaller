...
NumType AtlStrToNumHelper(__in_z const CharType *szVal, __deref_opt_out_z CharType **pEnd, __in int nRadix);

template <>
inline __int64 AtlStrToNumHelper<__int64, char>(__in_z const char *szVal, __deref_opt_out_z char **pEnd, __in int nRadix)
{
	return _strtoi64(szVal, pEnd, nRadix);
}

template <>
inline unsigned __int64 AtlStrToNumHelper<unsigned __int64, char>(__in_z const char *szVal, __deref_opt_out_z char **pEnd, __in int nRadix)
{
	return _strtoui64(szVal, pEnd, nRadix);
}

template <>
inline long AtlStrToNumHelper<long, char>(__in_z const char *szVal, __deref_opt_out_z char **pEnd, __in int nRadix)
{
	return strtol(szVal, pEnd, nRadix);
}

template <>
inline unsigned long AtlStrToNumHelper<unsigned long, char>(__in_z const char *szVal, __deref_opt_out_z char **pEnd, __in int nRadix)
{
	return strtoul(szVal, pEnd, nRadix);
}

template <>
inline int AtlStrToNumHelper<int, char>(__in_z const char *szVal, __deref_opt_out_z char **pEnd, __in int nRadix)
{
	return strtol(szVal, pEnd, nRadix);
}

template <>
inline unsigned int AtlStrToNumHelper<unsigned int, char>(__in_z const char *szVal, __deref_opt_out_z char **pEnd, __in int nRadix)
{
	return strtoul(szVal, pEnd, nRadix);
}

template <>
inline __int64 AtlStrToNumHelper<__int64, wchar_t>(__in_z const wchar_t *szVal, __deref_opt_out_z wchar_t **pEnd, __in int nRadix)
{
	return _wcstoi64(szVal, pEnd, nRadix);
}

template <>
inline unsigned __int64 AtlStrToNumHelper<unsigned __int64, wchar_t>(__in_z const wchar_t *szVal, __deref_opt_out_z wchar_t **pEnd, __in int nRadix)
{
	return _wcstoui64(szVal, pEnd, nRadix);
}

template <>
inline long AtlStrToNumHelper<long, wchar_t>(__in_z const wchar_t *szVal, __deref_opt_out_z wchar_t **pEnd, __in int nRadix)
{
	return wcstol(szVal, pEnd, nRadix);
}

template <>
inline unsigned long AtlStrToNumHelper<unsigned long, wchar_t>(__in_z const wchar_t *szVal, __deref_opt_out_z wchar_t **pEnd, __in int nRadix)
{
	return wcstoul(szVal, pEnd, nRadix);
}

template <>
inline int AtlStrToNumHelper<int, wchar_t>(__in_z const wchar_t *szVal, __deref_opt_out_z wchar_t **pEnd, __in int nRadix)
{
	return wcstol(szVal, pEnd, nRadix);
}

template <>
inline unsigned int AtlStrToNumHelper<unsigned int, wchar_t>(__in_z const wchar_t *szVal, __deref_opt_out_z wchar_t **pEnd, __in int nRadix)
{
	return wcstoul(szVal, pEnd, nRadix);
}

template <class NumType, class CharType>
NumType AtlStrToNumHelper(__in_z const CharType *szVal, __deref_opt_out_z CharType **pEnd);

template <>
inline double AtlStrToNumHelper<double, char>(__in_z const char *szVal, __deref_opt_out_z char **pEnd)
{
	return strtod(szVal, pEnd);
}

template <>
inline double AtlStrToNumHelper<double, wchar_t>(__in_z const wchar_t *szVal, __deref_opt_out_z wchar_t **pEnd)
{
	return wcstod(szVal, pEnd);
}

template <class NumType, class CharType>
inline errno_t AtlStrToNum(__out NumType *retValue, __in_z const CharType *szVal, __deref_opt_out_z CharType **pEnd, __in int nRadix)
{
...
template <class NumType, class CharType>
inline errno_t AtlStrToNum(__out NumType *retValue, __in_z const CharType *szVal, __deref_opt_out_z CharType **pEnd)
{
	ATLENSURE(retValue != NULL);
	errno_t saveErrno = Checked::get_errno();
