...
EXTERN_C const IID IID_ISClusResource;
    ...
    public:
        ...
        virtual /* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE get_MaintenanceMode( 
            /* [retval][out] */ BOOL *pbMaintenanceMode) = 0;
    ...
    typedef struct ISClusResourceVtbl
    {
        ...
        /* [helpstring][id][propget] */ HRESULT ( STDMETHODCALLTYPE *get_MaintenanceMode )( 
            ISClusResource * This,
            /* [retval][out] */ BOOL *pbMaintenanceMode);
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE ISClusResource_get_MaintenanceMode_Proxy( 
    ISClusResource * This,
    /* [retval][out] */ BOOL *pbMaintenanceMode);


void __RPC_STUB ISClusResource_get_MaintenanceMode_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE ISClusResource_put_MaintenanceMode_Proxy( 
    ISClusResource * This,
    /* [in] */ BOOL bMaintenanceMode);


void __RPC_STUB ISClusResource_put_MaintenanceMode_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
