...
__inline void __CRTDECL _tccpy_l(__out char *_Pc1, __in_z const char *_Cpc2, __in_opt _locale_t _Locale)
{
    _CRT_UNUSED(_Locale);
    _tccpy(_Pc1, _Cpc2);
}
...
#if __STDC_WANT_SECURE_LIB__
__inline __checkReturn_wat errno_t __CRTDECL _strncpy_s_l(__out_ecount_z(_Destination_size_chars) char *_Destination, __in size_t _Destination_size_chars, __in_z const char *_Source, __in size_t _Count, __in_opt _locale_t _Locale)
{
    _CRT_UNUSED(_Locale);
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _strncpy_s_l, __out_ecount_z(_Size) char, _Dest, __in_z const char *, _Source, __in size_t, _Count, __in_opt _locale_t, _Locale)

__DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(char *, __RETURN_POLICY_DST, _strncpy_l, _strncpy_s_l, __out_ecount_z(_Size) char, __out_ecount(_Count) char, _Dst, __in_z const char *, _Source, __in size_t, _Count, __in_opt _locale_t, _Locale)
{
    _CRT_UNUSED(_Locale);
#pragma warning( push )
#pragma warning( disable : 4996 )
...
__DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(char *, __RETURN_POLICY_DST, _strncpy_l, _strncpy_s_l, __out_ecount_z(_Size) char, __out_ecount(_Count) char, _Dst, __in_z const char *, _Source, __in size_t, _Count, __in_opt _locale_t, _Locale)
...
__DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(char *, __RETURN_POLICY_DST, _strncat_l, _strncat_s_l, __inout_ecount_z(_Size) char, __inout_z char, _Dst, __in_z const char *, _Source, __in size_t, _Count, __in_opt _locale_t, _Locale)
{
    _CRT_UNUSED(_Locale);
#pragma warning( push )
#pragma warning( disable : 4996 6054 )
...
__DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(char *, __RETURN_POLICY_DST, _strncat_l, _strncat_s_l, __inout_ecount_z(_Size) char, __inout_z char, _Dst, __in_z const char *, _Source, __in size_t, _Count, __in_opt _locale_t, _Locale)
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _strnset_s_l, __inout_ecount_z(_Size) char, _Dest, __in int, _Value, __in size_t, _Count, __in_opt _locale_t, _Locale)

__DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(char *, __RETURN_POLICY_DST, _strnset_l, _strnset_s_l, __inout_ecount_z(_Size) char, __inout_ecount_z(_MaxCount) char, _Dst, __in int, _Value, __in size_t, _MaxCount, __in_opt _locale_t, _Locale)
{
    _CRT_UNUSED(_Locale);
#pragma warning( push )
#pragma warning( disable : 4996 6054 )
...
__DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(char *, __RETURN_POLICY_DST, _strnset_l, _strnset_s_l, __inout_ecount_z(_Size) char, __inout_ecount_z(_MaxCount) char, _Dst, __in int, _Value, __in size_t, _Count, __in_opt _locale_t, _Locale)
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(errno_t, _strset_s_l, __inout_ecount_z(_Size) char, _Dest, __in int, _Value, __in_opt _locale_t, _Locale)

__DECLARE_CPP_OVERLOAD_INLINE_FUNC_0_2_EX(char *, __RETURN_POLICY_DST, _strset_l, _strset_s_l, __inout_ecount_z(_Size) char, __inout_z char, _Dst, __in int, _Value, __in_opt _locale_t, _Locale)
{
    _CRT_UNUSED(_Locale);
#pragma warning( push )
#pragma warning( disable : 4996 )
...
__DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_2_EX(char *, __RETURN_POLICY_DST, _strset_l, _strset_s_l, __inout_ecount_z(_Size) char, __inout_z char, _Dst, __in int, _Value, __in_opt _locale_t, _Locale)
