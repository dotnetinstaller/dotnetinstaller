...
_CRTIMP __checkReturn size_t __cdecl _mbsnlen(__in_z const unsigned char * _Str, __in size_t _MaxCount);
_CRTIMP __checkReturn size_t __cdecl _mbsnlen_l(__in_z const unsigned char * _Str, __in size_t _MaxCount, __in_opt _locale_t _Locale);
...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbslwr_l, _mbslwr_s_l, __inout_bcount(_Size) unsigned char, __inout_z unsigned char, _String, __in_opt _locale_t, _Locale)
...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsnbcat_l, _mbsnbcat_s_l, __inout_z unsigned char, __inout_z unsigned char, _Dest, __in_z const unsigned char *, _Source, __in size_t, _Count, __in_opt _locale_t, _Locale)
...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsnbcpy, __out_ecount_z(_Count) unsigned char, _Dest, __in_z const unsigned char *, _Source, __in size_t, _Count)
...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsnbcpy_l, _mbsnbcpy_s_l, __out_ecount_z(_Count) unsigned char, __out_ecount_z(_Count) unsigned char, _Dest, __in_z const unsigned char *, _Source, __in size_t, _Count, __in_opt _locale_t, _Locale)
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(errno_t, _mbsnbset_s, __inout_bcount_z(_Size) unsigned char, _Dest, __in unsigned int, _Val, __in size_t, _MaxCount)
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsnbset, _mbsnbset_s, __inout_bcount_z(_Size) unsigned char, __inout_bcount_z(_MaxCount) unsigned char, _String, __in unsigned int, _Val, __in size_t, _MaxCount)
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _mbsnbset_s_l, __inout_bcount_z(_Size) unsigned char, _Dest, __in unsigned int, _Val, __in size_t, _MaxCount, __in_opt _locale_t, _Locale)
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsnbset_l, _mbsnbset_s_l, __inout_bcount_z(_Size) unsigned char, __inout_bcount_z(_MaxCount) unsigned char, _String, __in unsigned int, _Val, __in size_t, _MaxCount, __in_opt _locale_t, _Locale)
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _mbsncat_s_l, __inout_bcount(_Size) unsigned char, _Dest, __in_z const unsigned char *, _Source, __in size_t, _Count, __in_opt _locale_t, _Locale)
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsncat_l, _mbsncat_s_l, __inout_z unsigned char, __inout_z unsigned char, _Dest, __in_z const unsigned char *, _Source, __in size_t, _Count, __in_opt _locale_t, _Locale)
...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsncpy_l, _mbsncpy_s_l, __out_z unsigned char, __out_z unsigned char, _Dest, __in_z const unsigned char *, _Source, __in size_t, _Count, __in_opt _locale_t, _Locale)
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(errno_t, _mbsnset_s, __inout_bcount_z(_Size) unsigned char, _Dest, __in unsigned int, _Val, __in size_t, _MaxCount)
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsnset, _mbsnset_s, __inout_bcount_z(_Size) unsigned char, __inout_bcount_z(_MaxCount) unsigned char, _String, __in unsigned int, _Val, __in size_t, _MaxCount)
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(errno_t, _mbsnset_s_l, __inout_bcount_z(_Size) unsigned char, _Dest, __in unsigned int, _Val, __in size_t, _MaxCount, __in_opt _locale_t, _Locale)
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsnset_l, _mbsnset_s_l, __inout_bcount_z(_Size) unsigned char, __inout_bcount_z(_MaxCount) unsigned char, _String, __in unsigned int, _Val, __in size_t, _MaxCount, __in_opt _locale_t, _Locale)
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1(errno_t, _mbsset_s, __inout_bcount_z(_Size) unsigned char, _Dest, __in unsigned int, _Val)
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsset, _mbsset_s, __inout_bcount_z(_Size) unsigned char, __inout_z unsigned char, _String, __in unsigned int, _Val)
...
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(errno_t, _mbsset_s_l, __inout_bcount_z(_Size) unsigned char, _Dest, __in unsigned int, _Val, __in_opt _locale_t, _Locale)
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsset_l, _mbsset_s_l, __inout_bcount_z(_Size) unsigned char, __inout_z unsigned char, _String, __in unsigned int, _Val, __in_opt _locale_t, _Locale)
...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(unsigned char *, __RETURN_POLICY_DST, _CRTIMP, _mbsupr_l, _mbsupr_s_l, __inout_bcount(_Size) unsigned char, __inout_z unsigned char, _String, __in_opt _locale_t, _Locale)
