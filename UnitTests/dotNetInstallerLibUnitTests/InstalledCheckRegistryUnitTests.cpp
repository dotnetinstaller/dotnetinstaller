...
void InstalledCheckRegistryUnitTests::testIsInstalled()
{
	...
	TestData testdata[] = 
	{
		...
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"DWORD", L"REG_DWORD", L"1", L"version_eq", true },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"DWORD", L"REG_DWORD", L"1", L"version_gt", false },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"DWORD", L"REG_DWORD", L"1", L"version_ge", true },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"DWORD", L"REG_DWORD", L"1", L"version_lt", false },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"DWORD", L"REG_DWORD", L"1", L"version_le", true },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"DWORD", L"REG_DWORD", L"2", L"version_eq", false },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"DWORD", L"REG_DWORD", L"2", L"version_gt", false },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"DWORD", L"REG_DWORD", L"2", L"version_ge", false },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"DWORD", L"REG_DWORD", L"2", L"version_lt", true },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"DWORD", L"REG_DWORD", L"2", L"version_le", true },
		// string
		...
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"String", L"REG_SZ", L"1.2.3.4", L"version_eq", true },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"String", L"REG_SZ", L"1.2.3.5", L"version_eq", false },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"String", L"REG_SZ", L"1.2.3.4", L"version_lt", false },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"String", L"REG_SZ", L"1.2.3.0", L"version_lt", false },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"String", L"REG_SZ", L"1.2.3.4", L"version_le", true },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"String", L"REG_SZ", L"1.2.3.0", L"version_le", false },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"String", L"REG_SZ", L"1.2.3.0", L"version_gt", true },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"String", L"REG_SZ", L"1.2.3.5", L"version_gt", false },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"String", L"REG_SZ", L"1.2.3.0", L"version_ge", true },
		{ L"HKEY_CURRENT_USER", L"SOFTWARE\\DVLib", L"String", L"REG_SZ", L"1.2.3.5", L"version_ge", false },
